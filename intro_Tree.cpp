...
int main() {
    ...
    // Print some nodes to verify structure
    cout << root->data << endl;         // Should print 1 (root)
    cout << root->left->data << endl;   // Should print 2 (left child of root)
    cout << root->right->data << endl;  // Should print 3 (right child of root)
